<template>
  ...
  >
    <p class="font-wheightbold ml-3 my-5">EDIT SHIPPING ADDRESS</p>
    ...
    >
      <div class="form-container">
        <label for="email" class="text-xs tracking-wider mb-2">Email</label>
        <input
      ...
      <div class="min-[750px]:flex">
        <div class="form-container">
          <label for="firstName" class="text-xs tracking-wider mb-2"
            >First Name</label
          >
          <input
        ...
        <div class="form-container">
          <label for="lastName" class="text-xs tracking-wider mb-2"
            >Last Name</label
          >
          <input
      ...
      <div class="form-container">
        <label for="country" class="text-xs tracking-wider mb-2">Country</label>
        <select
      ...
      <div class="min-[750px]:flex">
        <div class="form-container min-[750px]:w-2/3">
          <label for="address" class="text-xs tracking-wider mb-2"
            >Address</label
          >
          <input
        ...
        <div class="form-container min-[750px]:w-[150px]">
          <label for="number" class="text-xs tracking-wider mb-2"
            >Street Number</label
          >
          <input
      ...
      <div class="min-[750px]:flex">
        <div class="form-container">
          <label for="city" class="text-xs tracking-wider mb-2"
            >City / Suburb</label
          >
          <input
        ...
        <div class="form-container">
          <label for="zip" class="text-xs tracking-wider mb-2"
            >Zip / Postcode</label
          >
          <input
      ...
      <div class="form-container">
        <label for="mobile" class="text-xs tracking-wider mb-2"
          >Mobile Phone</label
        >
        <input
      ...
      <button type="submit" class="btn-form w-[95%] mx-3">SUBMIT</button>
    </form>
  </div>
</template>
