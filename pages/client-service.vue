  ...
  <div class="min-[1020px]:w-1/2 px-5 py-8 font-primary">
    ...
    <div class="mt-6">
      <AccordionComponent
        ...
        contentText='<p class="my-3">To check the status of your order, please log into your account.</p> 
      ...
      <AccordionComponent
        headerText="Payment"
        contentText='<p class="font-wheightbold mt-3">What payment methods do you accept?</p>
      ...
      />
      <AccordionComponent headerText="Shipping & Delivery" contentText="" />
      <AccordionComponent
        headerText="Returns"
        contentText='<p class="my-3">The Consumer has the right to withdraw from the contract, without providing reasons, 
      ...
      />
      <AccordionComponent headerText="Terms of Service" contentText="" />
    </div>
  </div>
</template>
