<template>
  <div class="min-[1020px]:w-1/2 px-5 py-8 font-primary">
    <h1 class="text-2xl">Client Service</h1>
    <div class="mt-6">
      <AccordionComponent
      ...
      />
      <AccordionComponent header-text="Shipping & Delivery" content-text="" />
      <AccordionComponent
        header-text="Returns"
      ...
      />
      <AccordionComponent header-text="Terms of Service" content-text="" />
    </div>
  </div>
</template>
  ...
  meta: [
    {
      name: "description",
      content:
        "Explore Client Services at Alessandra Grimoldi for information on order status, payment methods, shipping, returns, and terms of service. Luxury fashion brand specializing in leather jackets.",
    },
    {
      name: "keywords",
      content:
        "Alessandra Grimoldi, client services, order status, payment methods, shipping, returns, terms of service, luxury fashion, leather jackets",
    },
  ],
});
</script>
